...
class mysiteOptionGenerator {
	...
	function text( $value ) {
		...
		$out .= '<input type="text" name="' . MYSITE_SETTINGS . '[' . $value['id'] . ']" id="' . $value['id'] . '" class="mysite_textfield" value="' .
	...
	function color( $value ) {
		...
		$out .= '<input type="color" value="' .$val. '" id="' .$value['id']. '" name="' .$value['id']. '" class="mysite_colorselector"><br />';
	...
	function border( $value ) {
		...
		$out .= '<div class="colorSelector" id="' . $value['id'] . '_picker"><div></div></div>';
		$out .= '<input type="color" value="' . $value['default'][0] . '" id="' . $value['id'] . '_color" name="' . $value['id'] . '[' . $value['properties'][0] . ']" class="mysite_colorselector">';
	...
	function background($value) {
		...
		$out .= '<div class="colorSelector" id="' . $value['id'] . '_picker"><div></div></div>';
		$out .= '<input type="color" value="' . $value['default'][1] . '" id="' . $value['id'] . '_color" name="' . $value['id'] . '[background-color]" class="mysite_colorselector">';
	...
	function typography( $value ) {
		...
		$out .= '<div class="colorSelector" id="' .$value['id']. '_picker"><div></div></div>';
		$out .= '<input type="color" value="' .$color. '" id="' .$value['id']. '_color" name="' .$value['id']. '[color]" class="mysite_colorselector">';
	...
	function link( $value ) {
		...
		$out .= '<div class="colorSelector" id="' .$value['id']. '_picker"><div></div></div>';
		$out .= '<input type="color" value="' .$val. '" id="' .$value['id']. '" name="' .$value['id']. '[color]" class="mysite_colorselector">';
